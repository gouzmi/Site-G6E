...
$req = $bdd->prepare('SELECT * FROM commentaires WHERE id_billet = ? ORDER BY date_creation');
$req->execute(array($_GET['billet']));
...
<p><strong><?php echo htmlspecialchars($donnees['auteur']); ?></strong> le <?php echo $donnees['date_creation']; ?>
<br><br>
